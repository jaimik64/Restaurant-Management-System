<?php
    ...
    $query = "select * from banquet_booking_user  where status = 2 order by date DESC";
...
<html>
    ...
    <meta charset="utf-8">
        ...
        <title>Banquet Completed Order</title>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><a href="download_banquet.php?Bbid=<?php echo $r['Bbid'];?>">Print</a></td>
                </tr>
                <?php  
                    }
                }
