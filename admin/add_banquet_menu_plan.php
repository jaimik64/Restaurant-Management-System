<?php
    ...
    if(isset($_POST['add'])){
        if($_POST['name'] != '' && $_POST['detail'] != '' && $_POST['price'] != ''){
            ...
            $q = mysqli_query($con, "insert into banquet_menu_plan(name,menu,price) values('$name','$detail','$price')");
            if($q)
            {
           ...
           <h2> Add Plan </h2>
            <form method="post" action="#">
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control" id="exampleInputEmail1" required></textarea>
                </div>
                <div class="form-group">
                    <label>Price  </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="price" required>
                </div>
